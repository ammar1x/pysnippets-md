...
NumPy is probably your best friend for that. Check out [this](/tag/numpy)
...
plt.show()
```
![alt-text](/img/matplotlib/plot.png)
...
plt.show()
```
![alt-text](/img/matplotlib/lines.png)
...
plt.show()
```
![alt-text](/img/matplotlib/ticks.png)
...
plt.show()
```
![alt-text](/img/matplotlib/medium.png)
...
![alt-text](/img/matplotlib/axes.png)
...
plt.show()
```
![alt-text](/img/matplotlib/fill.png)
...
plt.show()
```
![alt-text](/img/matplotlib/advanced.png)
